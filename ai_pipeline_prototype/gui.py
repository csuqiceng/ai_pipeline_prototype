...
class PipelineAppUI:
    ...
    def _build_right_panel(self, parent: ttk.Frame) -> None:
        ...
        ttk.Label(control_frame, text="控制器连接:", font=("Microsoft YaHei UI", 9, "bold")).pack(side="left", anchor="center", fill="y")
        ttk.Button(control_frame, text="连接", style="Primary.TButton", command=self.on_connect).pack(side="left", padx=(12, 4), anchor="center", fill="y")
        ttk.Button(control_frame, text="断开", style="Secondary.TButton", command=self.on_disconnect).pack(side="left", padx=4, anchor="center", fill="y")
        
        ttk.Button(control_frame, text="注入报警", style="Secondary.TButton", command=self.on_inject_alarm).pack(side="left", padx=4, anchor="center", fill="y")
        ttk.Button(control_frame, text="清除报警", style="Secondary.TButton", command=self.on_clear_alarm).pack(side="left", padx=4, anchor="center", fill="y")
