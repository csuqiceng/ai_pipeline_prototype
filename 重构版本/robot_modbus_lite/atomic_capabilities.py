...
ATOMIC_CAPABILITIES: tuple[AtomicCapability, ...] = (
    ...
    AtomicCapability(
        ...
        "J 类关节命令保护",
        ("J1转到45度", "J2正转3度"),
        "AtomicParser._parse_joint -> AtomicResolver protective rejection",
        "guarded",
        "当前阶段禁止 Func106，J 类关节命令保护性拒绝，提示改用 Func108 笛卡尔位置/姿态指令。",
    ),
    AtomicCapability(
        "virtual_v",
        "V 类方向/姿态增量命令",
        ("上升3毫米", "左移5毫米", "RY正转2度"),
        "AtomicParser._parse_virtual -> Func108 relative target_*",
        "basic",
        "当前阶段禁止 Func107，方向/姿态增量按模板库口径生成 Func108 + position_increment。",
    ),
    AtomicCapability(
        "cartesian_c",
        "C 类笛卡尔命令",
    ...
    AtomicCapability(
        "sequence",
        "顺序组合命令",
        ("上升3毫米然后IO1开", "RY正转2度然后等待2秒然后IO1关"),
